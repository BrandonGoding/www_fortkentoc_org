...
STRIPE_ADULT_MEMBERSHIP_PRICE = config("STRIPE_ADULT_MEMBERSHIP_PRICE", default="")
STRIPE_YOUTH_MEMBERSHIP_PRICE = config("STRIPE_YOUTH_MEMBERSHIP_PRICE", default="")
STRIPE_FAMILY_MEMBERSHIP_PRICE = config("STRIPE_FAMILY_MEMBERSHIP_PRICE", default="")
STRIPE_UMFK_MEMBERSHIP_PRICE = config("STRIPE_UMFK_MEMBERSHIP_PRICE", default="")
