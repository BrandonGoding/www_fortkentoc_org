...
class Membership(models.Model):
    ...
    membership_type = models.CharField(max_length=2, choices=MembershipTypeChoices.choices)
    membership_season = models.ForeignKey('MembershipSeason', on_delete=models.CASCADE)
    parent_member = models.ForeignKey('self', on_delete=models.CASCADE, null=True, blank=True)
